...
![living](badges/Living-Denver.svg)   ![age](badges/Age-40.svg)    ![distro](badges/Platform-Debian.Kde.Firefox.svg)  ![skill](badges/Focus-Administration.svg)  ![views](https://komarev.com/ghpvc/?username=marcusholtz&style=flat&color=555555&label=Profile+Views)

<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=500&size=22&duration=3000&pause=1200&color=8B949E&center=true&vCenter=true&width=650&lines=Systems+Engineer;DevOps+%C2%B7+Networking+%C2%B7+Security;Web+Dev+%C2%B7+Administration;Generally+Fun+Guy" alt="Typing SVG" />
</p>
...
### More projects beyond my pinned repos. Click a category to browse.
...
│      Full CI/CD pipeline, self-managed with TLS termination
│
├─◆ <a href="https://github.com/MarcusHoltz/resume-generator">Auto-Updating Resume Pipeline</a>
│      CI-driven resume generation from structured source
│
├─◆ <a href="https://github.com/MarcusHoltz/Authentik-Traefik-MacVLAN">Authentik SSO with Traefik ForwardAuth</a>
│      Zero-trust authentication layer for self-hosted services
│
├─◆ <a href="https://blog.holtzweb.com/posts/turn-network-services-off-after-business-hours/">After-Hours Network Lockdown</a>
│      Scheduled WiFi, firewall, and SSO policy enforcement
│
├─◆ <a href="https://github.com/MarcusHoltz/proxmox-automatic-backups">ZFS Storage & Snapshot Architecture</a>
│      Automated backup and disaster recovery on Proxmox
│
├─◆ <a href="https://github.com/MarcusHoltz/grafana-loki-alloy-homelab-monitoring-stack">Grafana + Alloy + Loki Observability Stack</a>
│      Full monitoring pipeline for homelab infrastructure
│
...
│      Inline web application firewall with failover
│
└─────────────────────────────▰▱▰
</pre>
</details>
...
│      Container networking with traffic visibility
│
...
├─▣ Want the quick version?  curl marcusholtz.com/card
├─▣ Want the full story?   <a href="https://marcusholtz.com/">marcusholtz.com</a>
│
└──────────────────────────────▰▰▰
